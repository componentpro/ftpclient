...
namespace FtpClient
{
    ...
    public partial class Login : Form
    {
        ...
        public Login(LoginInfo s)
        {
            ...
            #region FTP
            chkPasv.Checked = s.PasvMode;
            txtCertificate.Text = s.Certificate;
            cbxSec.SelectedIndex = (int) s.SecurityMode;
            chkClearCommandChannel.Checked = s.ClearCommandChannel;
            #endregion
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            _info.ProxyType = (FtpProxyType) cbxProxyType.SelectedIndex;
            _info.ProxyMethod = (FtpProxyHttpConnectAuthMethod) cbxProxyMethod.SelectedIndex;

            #region FTP
            _info.PasvMode = chkPasv.Checked;
            _info.Certificate = txtCertificate.Text;
            _info.SecurityMode = (SecurityMode) cbxSec.SelectedIndex;
            _info.ClearCommandChannel = chkClearCommandChannel.Checked;
            #endregion
